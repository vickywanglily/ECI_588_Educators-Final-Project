...
##I reduced the n from 1000 to 500 and finally 200 to make the "stm" function work
...
findThoughts(tweets_stm,
             ...
             n = 10,
             thresh = 0.5)
##here is where I got stuck this time---Error in findThoughts(tweets_stm, texts = pbl_data_reduced, topics = 13,  : 
